  ...
  <p>
    ...
    <span className="text-white font-medium">Save & Connect</span>.
      ...
      <>
          ...
          <h1 className="text-[45px] font-semibold text-neutral-200 text-center leading-tight mt-4">
            Deploy OpenClaw under 60 Seconds
          </h1>

          <p className="text-[16px] text-neutral-400 text-center mt-4 mb-10">
            Avoid all technical complexity and one-click deploy your own 24/7 active <br />
            OpenClaw instance under 60 Seconds.
          </p>

          <div className="w-full max-w-5xl bg-zinc-900/70 backdrop-blur-xl border border-zinc-800 rounded-3xl p-6 shadow-2xl">
      ...
      <section className="w-full py-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-20 px-10">
