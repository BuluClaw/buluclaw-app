...
export default function Home() {
  ...
  const connectTelegram = async () => {
    if (!token) {
      setStatus({ type: "error", message: "Please enter bot token" });
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        ...
        setStatus({ type: "success", message: "Telegram connected successfully 🚀" });
      }
    } catch (error) {
  ...
  const deployBot = async () => {
    ...
    try {
      ...
      if (data.success) {
        setStatus({ type: "success", message: "Bot deployed successfully 🚀" });
      } else {
  ...
  return (
    <div className="min-h-screen w-full text-white flex flex-col items-center bg-gradient-to-b from-black via-[#0b1120] to-black">

      {/* ⭐ FIXED SIMPLECLAW HEADER */}
      <header className="w-full fixed top-0 z-50 bg-black/40 backdrop-blur-xl border-b border-white/10">
      ...
      {status && (
        <div
          className={`mb-8 px-6 py-4 rounded-2xl text-center font-medium ${
            status.type === "success"
      ...
      {step === "telegram" ? (
        ...
        <div className="w-full max-w-6xl bg-zinc-900/70 border border-zinc-800 rounded-3xl p-12 flex items-center justify-between gap-12">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="text-gray-400 text-sm space-y-4">
              <h3 className="text-white font-medium text-base">How to get your bot token?</h3>
              <p>
                1. Open Telegram and go to <span className="text-blue-400">@BotFather</span>.
              </p>
              <p>
                2. Start a chat and type{" "}
                <span className="bg-zinc-800 px-2 py-1 rounded-md text-gray-300">/newbot</span>.
              </p>
              <p>3. Follow steps to name your bot & get token.</p>
            </div>
        ...
        <>
          ...
          <div className="text-center mb-20 w-full px-4">
            <h2 className="text-5xl font-bold mb-6">Launch Your Own AI Bot in 60 Seconds</h2>
            <p className="text-zinc-400 text-lg">No coding. No server setup. Deploy instantly.</p>
          </div>
          ...
          <div className="w-full max-w-5xl bg-zinc-900/70 backdrop-blur-xl border border-zinc-800 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="flex justify-center gap-6 flex-wrap mb-14">
              {[
                ...
                >
                  <img src={model.icon} className="w-6 h-6" />
              ...
              {[
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (ch.id === "telegram") setStep("telegram");
                  }}
                  className={`px-6 py-3 rounded-full cursor-pointer flex items-center gap-3 transition ${
                ...
                >
                  <img src={ch.icon} className="w-6 h-6" />
                  <span>{ch.label}</span>
                </div>
              ))}
            </div>
      ...
      {/* COMPARISON DIVIDER */}
      <div className="w-full max-w-4xl mx-auto flex items-center justify-center relative mt-24">
        ...
        <div className="flex items-start justify-center gap-16 px-10">
          ...
          <div className="w-[480px]">
            ...
            <div className="space-y-4 text-[1.05rem] leading-relaxed text-neutral-300">
              ...
              <div className="flex justify-between">
                <span>Installing Node.js & NPM</span>
                <span>5 min</span>
              </div>
              ...
              <div className="flex justify-between">
                <span>Connecting AI provider</span>
                <span>4 min</span>
              </div>

              <div className="flex justify-between">
                <span>Pairing Telegram</span>
                <span>4 min</span>
              </div>
            </div>
            ...
            <p className="text-sm text-neutral-400 mt-8 leading-relaxed">
              If you're <span className="bg-red-800 px-2 py-0.5 rounded-md">non-technical</span>, multiply these times
              by 10 — you have to learn each step before doing.
            </p>
          </div>
          ...
          <div className="w-[480px]">
            ...
            <p className="text-neutral-400 leading-relaxed text-[1.05rem]">
              ...
              Simple, secure and fast connection.
            </p>
          </div>
        </div>
      </section>
